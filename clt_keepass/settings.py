"""
Django settings for clt_keepass project.
...
config.read('clt_keepass/settings.ini')
...
if SYS_ENV == 'dev':
    ...
    DEBUG = False
    ALLOWED_HOSTS = ['clt.manoa.hawaii.edu',]
...
WSGI_APPLICATION = 'clt_keepass.wsgi.application'
